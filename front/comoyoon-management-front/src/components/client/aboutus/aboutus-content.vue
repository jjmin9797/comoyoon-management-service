      ...
      <div id="primary" class="content-area col-lg-12">
        ...
        <main id="main" class="content-area-container site-main">
                  ...
                  <div class="main-block image-block">
                    ...
                    <div class="main-block-container image-block-container">
                      ...
                      <div class="main-block-header image-block-header">
                        <img
                          src="assets/images/comoyoon/aboutus/content/aboutus-content-3.jpg"
                          alt="Image"
                        />
                      </div>
                      <!-- /End Block header -->
                  ...
                  <div class="section-title">
                    ...
                    <div class="section-title-container">
                      ...
                      <div class="section-title-body">
                        ...
                        <!-- Divider -->
                        <div
                          class="hr-divider hr-divider-layout-1 accent-color"
                        ></div>
                      </div>
                      <!--/End Section title body -->
                    </div>
                  ...
                  <div class="main-block text-block">
                    ...
                    <div class="main-block-container text-block-container">
                      ...
                      <div class="main-block-body text-block-body">
                        ...
                        <div class="main-block-content text-block-content">
                          <p>
                            AboutUs-1 content content content content content
                            content
                          </p>
                        </div>
                        <!-- /End Block content -->
          ...
          <div class="main-section pt-0">
            ...
            <div class="container gx-4">
              <!-- row -->
              <div class="row gx-5 flex-row-reverse align-items-center">
                <!-- col-lg-6 -->
                <div class="col-lg-6">
                  <!-- Image block -->
                  <div class="main-block image-block">
                    ...
                    <div class="main-block-container image-block-container">
                      ...
                      <div class="main-block-header image-block-header">
                        <img
                          src="assets/images/comoyoon/aboutus/content/aboutus-content-2.jpg"
                          alt="Image"
                        />
                      </div>
                      <!-- /End Block header -->
                ...
                <!-- col-lg-6 -->
                <div class="col-lg-6 text-lg-end rtl-lg">
                  <!-- Section title -->
                  <div class="section-title">
                    <!-- Section title container -->
                    <div class="section-title-container">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="main-block image-block">
                    ...
                    <div class="main-block-container image-block-container">
                      ...
                      <div class="main-block-header image-block-header">
                        <img
                          src="assets/images/comoyoon/aboutus/content/aboutus-content-1.jpg"
                          alt="Image"
                        />
                      </div>
                      <!-- /End Block header -->
